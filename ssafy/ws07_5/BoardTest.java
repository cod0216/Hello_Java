...
public class BoardTest {
                ...
                case 1:
                    ...
                    if (loginUser == null) {
                        ...
                        outer: while (true) {
                            ...
                            System.out.println(um.getLoginUser().getNickName() + "님 환영합니다.");
                            System.out.println("-------------------------------------");
                            ...
                            switch (cmd2) {
                                ...
                                case 1:
                                    ...
                                    String articleContent = sc.next();
                                    am.getArticleSize();
                                    am.addArticle(new Article(am.getLastArticleIndex()+1, articleTitle, articleContent,
                                    ...
                                    outerComment: while (true) {
                                        ...
                                        switch (cmd3) {
                                            ...
                                            case 2:
                                                ...
                                                Comment[] dummy= am.getCommentList(articleNo);
                                                int index = am.getCommentList(articleNo).length;
                                                int value;
                                                if(index == 0 ) value = 0;
                                                else value = dummy[index-1].getCommentId();
                                                am.addComment(new Comment(value+1, articleNo, um.getLoginUser().getUserSeq(),
                                                        content));
                                                break;
                                            case 3:
                                                System.out.println("댓글 번호 입력 : ");
                                                am.removeComment(sc.nextInt());
                                                break;
                                            default:
    ...
    static void articleInfo(int articleNo) {
        ...
        System.out.println("-------------------------------------");
        Comment[] comments = am.getCommentList(articleNo);
        if (comments != null) {
            System.out.println("총 댓글의 수 : " + comments.length);
