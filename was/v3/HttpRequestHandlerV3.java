...
public class HttpRequestHandlerV3 implements Runnable{
    ...
    private void process() throws IOException {
        try(socket;
            ...
            String requestString = requsetToString(reader);
...
//            responseToClient(writer);
    ...
    private void search(PrintWriter writer, String requestString) {
        int startInedx = requestString.indexOf("q=  ");
        int endIndex = requestString.indexOf(" ", startInedx + 2);
        String query = requestString.substring(startInedx + 2, endIndex);
    ...
    private static String requsetToString(BufferedReader reader) throws IOException {
